@echo off
REM Script d'installation et configuration du projet Django
REM School Management - Gestion Scolaire SaaS
...
REM 6. Créer un superutilisateur
echo.
